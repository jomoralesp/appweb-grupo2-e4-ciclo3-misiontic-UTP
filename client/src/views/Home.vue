<template>
  <div class="home">
    ...
    <section class="container-fluid banner">
      <p>
        Participa en nuestros eventos, acumula <br />
        puntos y gana muchos premios
      </p>
    ...
    <section class="px-2">
      <div class="container-fluid containerCard">
        <CardProductHome
          nombre="Camiseta polo negro"
          imagen="camisetapolonegra_adobespark.png"
          descripcion="Camisetas tipo polo con logotipo empresa en tallas S, M, L y XL"
          puntos="850"
        ></CardProductHome>
        <CardProductHome
          nombre="Termo pequeño"
          imagen="TermoPequeño.png"
          descripcion="Termo para bebidas frías de 150ml"
          puntos="120"
        ></CardProductHome>
        <CardProductHome
          nombre="Sombrilla recogible"
          imagen="sombrillarecogible_adobespark.png"
          descripcion="Sombrilla recogible para llevar consigo en el bolso"
          puntos="500"
        ></CardProductHome>
        <div class="categoria">
    ...
    <section class="eventProximo">
      <div class="titleSection">Proximos eventos</div>
